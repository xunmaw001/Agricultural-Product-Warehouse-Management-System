    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑委托出入库订单</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑委托出入库订单</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">委托出入库订单信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    <div class="form-group col-md-6">
                                        <label>用户</label>
                                        <div>
                                            <select id="yonghuSelectyonghuSelect" name="yonghuSelect"
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>操作类型</label>
                                       <select id="caozuoTypesSelect" name="caozuoTypes" class="form-control">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>操作时间</label>
                                       <input id="updateTime-input" name="updateTime" size="20"  type="month" class="form-control">
                                   </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#yonghuId") !=null){
            ...
            httpJson("entrustInOutOrder/" + urlParam, "POST", data, (res) => {
                if(res.code == 0)
                {
                    window.sessionStorage.removeItem('addentrustInOutOrder');
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationCaozuotypesSelect(){
            var caozuoTypesSelect = document.getElementById('caozuoTypesSelect');
            if(caozuoTypesSelect != null && caozuoTypesOptions != null  && caozuoTypesOptions.length > 0 ){
                for (var i = 0; i < caozuoTypesOptions.length; i++) {
                    caozuoTypesSelect.add(new Option(caozuoTypesOptions[i].indexName,caozuoTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(caozuoTypesSelect != null && caozuoTypesOptions != null  && caozuoTypesOptions.length > 0 ) {
            for (var i = 0; i < caozuoTypesOptions.length; i++) {
                if (caozuoTypesOptions[i].codeIndex == ruleForm.caozuoTypes) {//下拉框value对比,如果一致就赋值汉字
                        caozuoTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    // 获取当前详情
    function getDetails() {
        var addentrustInOutOrder = window.sessionStorage.getItem("addentrustInOutOrder");
        if (addentrustInOutOrder != null && addentrustInOutOrder != "" && addentrustInOutOrder != "null") {
            window.sessionStorage.removeItem('addentrustInOutOrder');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("entrustInOutOrder/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationCaozuotypesSelect();
            <!--  初始化级联表的下拉框  -->
