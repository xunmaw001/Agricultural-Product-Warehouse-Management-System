            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">委托出入库订单详情登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="caozuoValue" name="caozuoValue" class="form-control"
                                               v-model="ruleForm.caozuoValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="entrustInOutOrderId" name="entrustInOutOrderId" v-model="ruleForm.entrustInOutOrderId" readonly type="hidden">
                                ...
                                <div class="form-group col-md-6">
                                    <label>状态</label>
                                    <input id="entrustValue" name="entrustValue" class="form-control"
                                           v-model="ruleForm.entrustValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "entrustInOutOrderList/info/" + id,
